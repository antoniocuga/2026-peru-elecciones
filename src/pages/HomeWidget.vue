          ...
          <div class="card card-candidate border-1"
            ...
            <div class="card-body d-flex align-items-center justify-content-between p-2">
              <img :src="getImageCandidate(c.candidato_id)"
                   ...
                   :style="`border-color: ${c.color} !important;`" alt="Foto de candidato a la presidencia del Perú"/>
        ...
        <div class="col-12" v-if="congresoStackTotal > 0 || senadoStackTotal > 0">
          <div class="widget-parliament-summary mt-3 px-0 px-sm-1">
            ...
            <div v-if="senadoStackTotal > 0" class="widget-parliament-row">
              ...
              Cámara de senadores <span class="text-light fw-normal">({{ senadoStackTotal }})</span>
              </div>
              <div
                class="stacked-bar"
                role="img"
            ...
            <div v-if="congresoStackTotal > 0" class="widget-parliament-row mb-2 mb-md-0">
              <div class="widget-parliament-label small text-light fw-semibold mb-1">
                Cámara de diputados <span class="text-light fw-normal">({{ congresoStackTotal }})</span>
              </div>
              <div
                class="stacked-bar"
                role="img"
