  ...
  <div class="mapa-resultados-container">
    <div class="row">
      <div class="col-12 text-right">
        ...
        <svg v-show="showPeruMap" width="100%" :height="height" class="plan-vector-map" ref="svgmap" id="mapa_segunda">
          <g ref="base"></g>
  ...
  export default {
    ...
    methods: {
      ...
      getExtranjeroCountriesFileUrl() {
        if (import.meta.env.DEV) return `/data-segunda-vuelta/extranjero_paises.json?t=${Date.now()}`
        return `/especiales/resultados-onpe-elecciones-2026/data-segunda-vuelta/extranjero_paises.json?t=${Date.now()}`
      },
      async fetchJson(url) {
