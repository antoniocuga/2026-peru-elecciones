...
```{r}
avance_general <- as.numeric(content(httr::GET("https://api.resultados.eleccionesgenerales2021.pe/results/10/000000?name=param"), as="parsed")$generals$generalData$POR_ACTAS_PROCESADAS)
```
